...
int main(int argc, char const *argv[]) {
    ...
    clock_t remov11 = clock();
    mapa1 = remove2(mapa1, TAM-1);
    remov11 = clock() - remov11;

    clock_t remov21 = clock();
    mapa2 = remove2(mapa2, TAM-1);
    remov21 = clock() - remov21;

    total1 = (double)(remov11) / CLOCKS_PER_SEC;
    total2 = (double)(remov21) / CLOCKS_PER_SEC;

    printf("Remove (TAM - 1): Mapa 1: %.16gs - Mapa 2: %.16gs\n", total1, total2);

    clock_t remov12 = clock();
    mapa1 = remove2(mapa1, TAM+1);
    remov12 = clock() - remov12;

    clock_t remov22 = clock();
    mapa2 = remove2(mapa2, TAM+1);
    remov22 = clock() - remov22;

    total1 = (double)(remov12) / CLOCKS_PER_SEC;
    total2 = (double)(remov22) / CLOCKS_PER_SEC;
...
void imprimeArvores (Mapa* m1, Mapa* m2) {
    printf("\nImprime na ordem que os valores foram adicionados:\n");
    printf("\nÁrvore 1:\n");
    imprime(m1);
    printf("\nÁrvore 2:\n");
    imprime(m2);
